...
const _actionqueue = __webpack_require__(9725);
...
const originalPushState =  true ? window.history.pushState.bind(window.history) : 0;
const originalReplaceState =  true ? window.history.replaceState.bind(window.history) : 0;
...
const _asynclocalstorage = __webpack_require__(4471);
...
const _constants = __webpack_require__(1824);
// @ts-ignore
...
/******/ __webpack_require__.O(0, [971], function() { return __webpack_exec__(2019); });
