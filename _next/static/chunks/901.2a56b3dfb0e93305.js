...
const functions = {
    ...
    loadContract: async (args)=>{
        const { AcurastPriceOracle } = await __webpack_require__.e(/* import() */ 561).then(__webpack_require__.bind(__webpack_require__, 6561));
    ...
    getState: async ()=>{
        return {
            btcPrice: (Number(state.zkapp.priceDataBTC.get().toBigInt()) / 1000).toFixed(2),
            ethPrice: (Number(state.zkapp.priceDataETH.get().toBigInt()) / 1000).toFixed(2),
            minaPrice: (Number(state.zkapp.priceDataMINA.get().toBigInt()) / 1000).toFixed(2)
        };
    },
    createUpdateTransaction: async (args)=>{
        const currentNum = state.zkapp.counter.get();
        const transaction = await o1js__WEBPACK_IMPORTED_MODULE_0__/* .Mina */ .No.transaction(()=>{
            state.zkapp.update(currentNum, "", "", "", ""); // todo fill with correct values
        });
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [674], function() { return __webpack_require__(4255); })
...
/******/ 			return "static/chunks/" + (chunkId === 674 ? "982f5ae2" : chunkId) + "." + {"561":"0fcc6e3154012356","674":"25cc47355524462b"}[chunkId] + ".js";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ 	!function() {
/******/ 		__webpack_require__.p = "/mina-zkoracles/_next/";
/******/ 	}();
/******/ 	
